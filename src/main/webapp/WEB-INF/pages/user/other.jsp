...
<div id="page-content-wrapper">
	<div class="container" id="container-cate">
		<section id="cates-view">
				...
				<!-- <section id="banner-lieral" class="banner">
									<div class="img-bg">
									<h1>អក្សរសាស្ត្រ</h1>
									</div>
						</section> -->
					...
					<div class="row">
						<div class="col-sm-3" id="left-side-nav" >
					   	   <ul class="category-menu nav nav-pills nav-stacked">
					   	   		<li class="bg-cate"><span><i class="fa fa-tags" aria-hidden="true"></i>
			  	   </span>ផ្សេងៗ
			  	   				</li>
			  	   				<li class="cates-main active">
			  	   				<a data-toggle="pill" href="#khmer">ភាសាខ្មែរ</a> 
			  	   				</li>
			  	   				<li class="cates-main">
			  	   				<a data-toggle="pill" href="#culture">វប្បធម៌</a> 
			  	   				</li>
			  	   				<li class="cates-main">
			  	   				<a data-toggle="pill" href="#poem">កំណាព្យ</a> 
			  	   				</li>
			  	   				<li class="cates-main">
			  	   				<a data-toggle="pill" href="#history">ប្រវត្តិវិទ្យា</a> 
			  	   				</li>
			  	   				<li class="cates-main">
			  	   				<a data-toggle="pill" href="#geography">ភូមិវិទ្យា</a> 
			  	   				</li>
					   	   </ul>
					   </div>
