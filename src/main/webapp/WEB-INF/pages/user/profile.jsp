		...
		<div class="container" >
			<div class="row section profile topspace-profile">
						...
						<!-- <div class="user-name">ជឹម មិនា</div> -->
							...
							<li class="about"><a data-toggle="tab" href="#infor"><i class="fa fa-user" aria-hidden="true"></i>អំពីខ្ញុំ </a></li>
								<li class="about"><a data-toggle="tab" ng-click="getDocumentByUser(2)" href="#mydoc"><i class="fa fa-th-list" aria-hidden="true"></i>បញ្ជីរគ្រប់គ្រងឯកសារ</a></li>
								<li class="about" ><a data-toggle="tab" ng-click="getLogByUser()" href="#viewed"><i class="fa fa-eye" aria-hidden="true"></i>ឯកសារដែលបានមើល</a></li>
