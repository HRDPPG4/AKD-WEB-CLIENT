...
<link rel="shortcut icon" href="${ContextPath}/resources/user/img/AKD.png">
    ...
    <link rel="stylesheet" href="${ContextPath}/resources/user/css/style_login.css">
    <!-- AngularJS -->
	    ...
	    <ul>
	        <li>
	            ...
	            <span class="form_hint">សូមបញ្ចូលអ៊ីម៉ែលឲ្យបានត្រឹមត្រូវ</span>
	             <p class="mail"><img src="${ContextPath}/resources/user/img/login/contact.png" alt=""></p>
	        </li>
	        <li>
	            ...
	            <p class="psw"><img src="${ContextPath}/resources/user/img/login/lock.png" alt=""></p>
	        </li>
         </ul>
...
<%-- <div class="account">
    ...
    <div class="span"><a href="#"><img src="${ContextPath}/resources/user/img/login/facebook.png" alt=""/><i>ចូលប្រើប្រាស់ជាមួយ Facebook</i><div class="clear"></div></a></div>	
    <div class="span1"><a href="#"><img src="${ContextPath}/resources/user/img/login/twitter.png" alt=""/><i>ចូលប្រើប្រាស់ជាមួយធ្វីសធើ</i><div class="clear"></div></a></div>
    <div class="span2"><a href="#"><img src="${ContextPath}/resources/user/img/login/gplus.png" alt=""/><i>ចូលប្រើប្រាស់ជាមួយហ្គោហ្គោលផ្លើស</i><div class="clear"></div></a></div>
</div>	 --%>
<!-- end-account -->
<div class="clear"></div>	
</div>
