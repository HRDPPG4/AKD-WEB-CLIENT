...
<div class="modal fade" id="addDocument" role="dialog" ng-controller="DocumentCtrl">
...
<!-- 			<div ng-show="theFile"> -->
			<form role="form">
			    <div class="form-group">
			      <label>Title:</label><!-- {{theFile.name}} -->
			    ...
			    <div class="form-group">
			      <label>Category:</label>		      
			        <select class="form-control" ng-model="catID">			       
                        <option ng-repeat="x in getAllCategory | filter:{ CAT_LEVEL: '1'}" value="{{x.CAT_ID}}">{{x.CAT_NAME}}</option>
                   	</select>
			    </div>
