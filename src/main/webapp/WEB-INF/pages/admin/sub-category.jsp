      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="sub-category"><i class="fa fa-circle-o"></i> Sub Categories</a></li>
          </ul>
        </li>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <!--   <th><a href="add-sub-category.html"><button class="btn btn-flat btn-primary">Add Sub Categories</button></a></th> -->
                	<th>
                		<button class="btn btn-flat btn-primary" data-toggle="modal" data-target="#addSubModal">Add Sub Categories</button>
                	</th>
                </tr>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Sub Category title ">
                </div>
