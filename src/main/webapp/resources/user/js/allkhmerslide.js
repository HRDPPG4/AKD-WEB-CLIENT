...
/*$('.menu-basic li a').click(function(e) {
	
	  var $this = $(this);
	  if (!$this.hasClass('actives-main')) {
	...
	/*$(".menu-basic li a").on("click", function(e){
	 //   e.preventDefault();

	    $(".menu-basic li").removeClass("actives-main"); //Remove any previously "active" li
	    $("#home, #about, #contact").hide(); //Hide all "pages"
	    $($(this).prop("href")).show(); //Show only the current target
	    $(this).closest("li").addClass("actives-main"); //Set click li as active
	});*/
	...
	$(document).ready(
	  function()
	  {
	    $(".menu-basic li").click(make_button_active);
	  }  
	)
